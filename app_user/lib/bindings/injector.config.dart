...
import 'package:app_user/bindings/injector.dart' as _i11;
...
import 'package:app_user/modules/auth/domain/usecases/login_usecase.dart'
    as _i10;
import 'package:app_user/network/dio_provider.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i5.Dio>(() => registerModule.getDio);
    gh.lazySingleton<_i6.AuthDataSourceImpl>(() => _i6.AuthDataSourceImpl());
    gh.lazySingleton<_i7.PreferenceManagerImpl>(() =>
        _i7.PreferenceManagerImpl(preferences: gh<_i3.SharedPreferences>()));
    gh.lazySingleton<_i8.AuthRepository>(
        () => _i9.AuthRemoteRepositoryImpl(dio: gh<_i5.Dio>()));
    gh.lazySingleton<_i10.LoginUseCase>(
        () => _i10.LoginUseCase(authRepository: gh<_i8.AuthRepository>()));
    return this;
  }
}
